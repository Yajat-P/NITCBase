...
int BlockAccess::renameRelation(char oldName[ATTR_SIZE], char newName[ATTR_SIZE]){
	...
	RecId searchIndex = BlockAccess::linearSearch(RELCAT_RELID, RelName, newRelationName, EQ);
	...
	searchIndex = BlockAccess::linearSearch(RELCAT_RELID, RelName, oldRelationName, EQ);
	...
	for (int attrIndex = 0; attrIndex < relCatRecord[RELCAT_NO_ATTRIBUTES_INDEX].nVal; attrIndex++) {
		...
		searchIndex = BlockAccess::linearSearch(ATTRCAT_RELID, RelName, oldRelationName, EQ);
...
int BlockAccess::renameAttribute(char relName[ATTR_SIZE], char oldName[ATTR_SIZE], char newName[ATTR_SIZE]) {
	...
	RecId searchIndex = BlockAccess::linearSearch(RELCAT_RELID, RelName, relNameAttr, EQ);
    ...
    while (true) {
		...
		searchIndex = BlockAccess::linearSearch(ATTRCAT_RELID, RelName, relNameAttr, EQ);
...
int BlockAccess::deleteRelation(char relName[ATTR_SIZE]) {
	...
	RecId relCatRecId = BlockAccess::linearSearch(RELCAT_RELID, RelName, relNameAttr ,EQ);
    ...
    ***/
    ...
    while(true) {
        ...
        RecId attrCatRecId = BlockAccess::linearSearch(ATTRCAT_RELID, RelName, relNameAttr, EQ);
